...
import createArtifact from '../../old-src/stages/createArtifact';
import deploy from '../../old-src/stages/deploy';
import cleanup from '../../old-src/stages/cleanup';
...
import buildAndDeploy from '../../old-src/execution/buildAndDeploy';
