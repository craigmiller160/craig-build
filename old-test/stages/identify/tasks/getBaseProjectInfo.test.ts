import getBaseProjectInfo from '../../../../old-src/stages/identify/tasks/getBaseProjectInfo';
...
import stageName from '../../../../old-src/stages/identify/stageName';
import { TASK_NAME } from '../../../../old-src/stages/identify/tasks/getBaseProjectInfo';
	...
	it('get DockerApplication ProjectInfo, no group', async () => {
		getCwdMock.mockImplementation(() =>
			path.resolve(
				...
				'test',
				'__working-dirs__',
				'dockerReleaseApplicationNoGroup'
			)
		);
		const result = await getBaseProjectInfo(
			ProjectType.DockerApplication
