...
import buildAndTest from '../../../old-src/stages/createArtifact/tasks/buildAndTest';
import bumpNpmBeta from '../../../old-src/stages/createArtifact/tasks/bumpNpmBeta';
import publish from '../../../old-src/stages/createArtifact/tasks/publish';
